...
public class ModItems {
    ...
    public static final Item RIFTSTEEL_HELMET = registerItem("riftsteel_helmet", new ArmorItem(ModArmorMaterials.RIFTSTEEL, ArmorItem.Type.HELMET, new FabricItemSettings()));
