...
public class EyeOfTheVoidEntity extends Entity implements FlyingItemEntity {
    private static final TrackedData<ItemStack> ITEM = DataTracker.registerData(EyeOfTheVoidEntity.class, TrackedDataHandlerRegistry.ITEM_STACK);
    ...
    public EyeOfTheVoidEntity(EntityType<? extends EyeOfTheVoidEntity> entityType, World world) {
        super(entityType, world);
    }

    public EyeOfTheVoidEntity(World world, double x, double y, double z) {
        this((EntityType<? extends EyeOfTheVoidEntity>) ModEntities.EYE_OF_THE_VOID, world);
        this.setPosition(x, y, z);
    }

    public void setItem(ItemStack stack) {
        if (!stack.isOf(ModItems.EYE_OF_THE_VOID) || stack.hasNbt()) {
    ...
    public ItemStack getStack() {
        ...
        return itemStack.isEmpty() ? new ItemStack(ModItems.EYE_OF_THE_VOID) : itemStack;
    }
