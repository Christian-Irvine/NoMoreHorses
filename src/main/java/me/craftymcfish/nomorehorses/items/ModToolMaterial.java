...
public enum ModToolMaterial implements ToolMaterial {
    ...
    BAGUETTE(MiningLevels.STONE, 251, 4.5f, -1f, 5, () -> Ingredient.ofItems(Items.BREAD)),
    RIFTSTEEL(MiningLevels.NETHERITE, 1831, 17f, -1f, 17, () -> Ingredient.ofItems(ModItems.RIFTSTEEL_CLUMP));
